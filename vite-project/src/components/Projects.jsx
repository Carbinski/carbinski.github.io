...
const projects = [
    ...
    },
    {
        ...
        description: "Minimalist terminal-style mobile app for logging calories, protein, carbs, and fat with a CLI-inspired interface.",
        extendedDescription: "MACRO_TRACKER_V3.0 is a deployed macro tracking app built around a black-and-white, monospaced terminal aesthetic: status headers, daily summary panels, and a structured log-food flow with search and execute actions. Maintained for a real user with ongoing iteration.",
        image: "/projects/macro-tracker.png",
        imageGallery: [],
        tags: ["Mobile", "Health", "UX"],
        demoUrl: "#",
        githubUrl: "https://github.com/Carbinski/Macro-Tracking-App"
    },
    {
        id: -7,
        title: "LASRP",
        description: "A public site listing social resources for people in the LA area, with filtering and room to grow via automation.",
        extendedDescription: "LASRP (Los Angeles Social Resource Project) is a live directory co-built with Arthur, a medical student partner. The site hosts many curated resources with basic filtering. The roadmap includes an AI-assisted scraping backend to reduce manual data entry; development pace ties partly to grant outcomes.",
        image: "/projects/lasrp.svg",
        imageGallery: [],
        tags: ["React", "Next.js", "Vercel"],
        demoUrl: "https://lasrp-site.vercel.app",
        githubUrl: "https://github.com/lasrp-admin/lasrp-site"
    },
    {
        id: -6,
